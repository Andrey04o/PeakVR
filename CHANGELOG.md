...
- Added "Make image sharper" setting (disabled by default)
- Added Camera roll setting (disabled by default)
- Added Copy Head Rotation (disabled by default) (also works with flat mode)
- Improved hold item in one hand
- Improved hands syncronization
- Updated README
